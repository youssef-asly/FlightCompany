...
public class mainTest {
    ...
    public void validateTicket() {
        ...
        ticketsList.FillDB();//Create hardcoded data that willac as your datasource

        Assert.assertEquals(true, ticketsList.validateTicket(130));
    ...
    public void validateBaggage() {
        ...
        Assert.assertEquals(false, ticketsList.validateBaggage(null,"BARCELONA"));
        Assert.assertEquals(false, ticketsList.validateBaggage(221,"HAIFA"));
        Assert.assertEquals(true, ticketsList.validateBaggage(225,"CHICAGO"));
    }
    @Test
